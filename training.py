...
# =====================================================
# IMPROVED MODEL WITH ATTENTION FOR RAG
# =====================================================
...
class ImprovedSeq2SeqRAG(nn.Module):
    ...
    def _combine_bi_hidden(self, h, c):
        ...
        if num_directions == 1:
            h_cat = h_resh[:,0]  # (num_layers, B, H)
            c_cat = c_resh[:,0]
        else:
            # concat forward & backward on last dim -> (num_layers, B, H*2)
    ...
    def encode(self, input_seq):
        """For inference - FIXED to match training!"""
...
class RAGDataset(Dataset):
    def __init__(self, data, vocab=None, max_len_input=200, max_len_output=150):
        ...
        if vocab is None:
            ...
            all_text = []
            for d in self.data:
                # Combine question, context, and answer
...
# =====================================================
# K-FOLD TRAINING WITH IMPROVEMENTS
# =====================================================
